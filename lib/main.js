    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (github_1.context.payload.pull_request) {
                prDescription = github_1.context.payload.pull_request.body;
            }
            //const description = "Hello, if you solve this issue, you can get 220.9283 CC2."
            console.log("This is the message I found: " + prDescription);
            if (regexpCC2.test(prDescription)) { // Note: If user specifies more than one amount ("e.g 'I could give you 100 CC2 or 220 CC2, the following
                // function chooses the first one (i.e. 100 CC2) automatically.)
                const amountPlusCC2 = regexpCC2.exec(prDescription)[0];
